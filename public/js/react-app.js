...
var App = require('./react/react-app').default;

ReactDOM.render(React.createElement(App, null), document.getElementById('example'));

},{"./react/react-app":180,"react":169,"react-dom":2}],171:[function(require,module,exports){
'use strict';
...
var QuestionMultiAnswers = _react2.default.createClass({
    displayName: 'QuestionMultiAnswers',
    ...
    handleTick: function handleTick(event) {
        ...
        return _react2.default.createElement(
            ...
            this.state.answers.map(function (value, key) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-8' },
                        _react2.default.createElement(ChangableInput, {
                            name: 'data-' + key,
                            value: value,
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-3 item-control' },
                        _react2.default.createElement(
                            'span',
                            { className: 'delete', value: key, onClick: that.handleDelete },
                            'delete'
                        )
                    )
                );
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'col-sm-8' },
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'newAnswer', onKeyDown: this.handleAdd })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'col-sm-3' },
...
exports.default = QuestionMultiAnswers;

},{"./../changable-input":174,"react":169}],172:[function(require,module,exports){
'use strict';
...
var QuestionSimpleAnswers = _react2.default.createClass({
    displayName: 'QuestionSimpleAnswers',
...
exports.default = QuestionSimpleAnswers;

},{"./../changable-input":174,"react":169}],173:[function(require,module,exports){
'use strict';
...
var QuestionTextAnswers = _react2.default.createClass({
    displayName: 'QuestionTextAnswers',
...
exports.default = QuestionTextAnswers;
...
var ChangableInput = _react2.default.createClass({
    displayName: 'ChangableInput',
    ...
    render: function render() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'ci-block ' + (editing ? 'hidden' : 'visible'),
...
exports.default = ChangableInput;

},{"react":169,"react-dom":2}],175:[function(require,module,exports){
'use strict';
...
var NewQuestionButton = _react2.default.createClass({
    displayName: 'NewQuestionButton',
    ...
    render: function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement(QuestionModal, { ref: 'modal', parent: this }),
            _react2.default.createElement(
                'div',
                { className: 'small-4 columns', style: { padding: '1em' } },
                _react2.default.createElement(
                    'div',
                    { className: 'btn btn-primary', style: { padding: '.75em 1em' }, onClick: this.handleClick },
                    'Add new question'
                )
            )
        );
...
exports.default = NewQuestionButton;

},{"./question-modal":178,"react":169}],176:[function(require,module,exports){
'use strict';
...
var QuestionForm = _react2.default.createClass({
    ...
    imageUpload: function imageUpload(event) {
        ...
        if (file.name.length < 1) {} else if (file.size > 500000) {
    ...
    render: function render() {
        ...
        if (this.state.type == 'single') {
            answers = _react2.default.createElement(QuestionSimpleAnswers, { ref: 'answers', data: this.state.model });
        } else if (this.state.type == 'multi') {
            answers = _react2.default.createElement(QuestionMultiAnswers, { ref: 'answers', data: this.state.model });
        } else if (this.state.type == 'text') {
            answers = _react2.default.createElement(QuestionTextAnswers, { ref: 'answers', data: this.state.model });
        }

        var imagePreview = model.image.length > 1 ? _react2.default.createElement(
            'div',
            { id: 'preview' },
            _react2.default.createElement('img', { src: model.image, style: {
                    'max-width': '100%'
                } }),
            _react2.default.createElement(
                'a',
                { className: 'btn btn-danger', onClick: this.removeImage },
                'Видалити'
            )
        ) : '';

        var spinner = this.state.uploading ? _react2.default.createElement('i', { className: 'fa pull-right fa-circle-o-notch fa-spin', style: {
                'font-size': '24px'
            } }) : '';
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'small-12 columns lbl' },
                            'Питання'
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'small-12 columns' },
                            _react2.default.createElement('textarea', { rows: '5', defaultValue: model.question, ref: 'question', className: 'form-control' })
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                '(опціонально, буде перед текстом)'
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'form',
                                { id: 'image', enctype: 'multipart/form-data', action: '/attachment/upload' },
                                _react2.default.createElement('input', { type: 'file', name: 'image', onChange: this.imageUpload }),
                                imagePreview
                            )
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'description' },
                                '(використовуються для інтелектуального підбору питань)'
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'small-12 columns' },
                            _react2.default.createElement(_reactTagsinput2.default, { value: this.state.model.tags, onlyUnique: true, onChange: this.handleTagsChange })
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'select',
                                { value: model.type, onChange: this.handleTypeChange, className: 'form-control' },
                                _react2.default.createElement(
                                    'option',
                                    { value: 'single' },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'description' },
                                '(помітьте правильні, чи введіть текст)'
                            )
                        ),
                        _react2.default.createElement(
                            'div',
...
},{"./answers/multi":171,"./answers/simple":172,"./answers/text":173,"react":169,"react-dropzone":3,"react-tagsinput":4}],177:[function(require,module,exports){
'use strict';
...
var _newQuestionButton = require('./new-question-button');

var _newQuestionButton2 = _interopRequireDefault(_newQuestionButton);
    ...
    _createClass(QuestionList, [{
        ...
        value: function render() {
            var a = 0,
                ...
                a++;
                return _react2.default.createElement(_question2.default, { key: item.id + '' + a,
                    data: item,
                    number: a,
                    parent: that,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'row' },
                    _react2.default.createElement(_newQuestionButton2.default, { parent: this }),
                    _react2.default.createElement(
                        'span',
                        { className: 'edit-status', style: { opacity: editedOpacity } },
                        'Тести відредаговані - збережіть тему, аби зберегти зміни'
                    )
                ),
                list
            );
...
},{"./new-question-button":175,"./question":179,"react":169}],178:[function(require,module,exports){
'use strict';
...
var QuestionModal = _react2.default.createClass({
    ...
    render: function render() {
        ...
        if (this.state.visible) {
            return _react2.default.createElement(
                'div',
                { className: 'modal in', id: 'questionEditor', tabindex: '-1', role: 'dialog', 'aria-labelledby': 'myModalLabel',
                    style: style },
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'button',
                                { type: 'button', className: 'close', onClick: this.hide },
                                _react2.default.createElement(
                                    'span',
                                    { 'aria-hidden': 'true' },
                                    '×'
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(QuestionForm, { ref: 'child', parent: this })
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-default', onClick: this.hide },
                                'Close'
                            ),
                            _react2.default.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-primary', onClick: this.handleSubmitClick },
                                'Save changes'
                            )
                        )
                    )
...
},{"./question-form":176,"react":169}],179:[function(require,module,exports){
'use strict';
...
var _questionModal = require('./question-modal');
    ...
    _createClass(Question, [{
        ...
        value: function render() {
            ...
            var tags = elem.tags.map(function (item) {
                return _react2.default.createElement(
                    'span',
                    { className: 'label label-info', key: item, style: { marginRight: '.5em' } },
                    item
                );
            });
            ...
            return _react2.default.createElement(
                'div',
                { className: 'row question-holder' },
                _react2.default.createElement(_questionModal2.default, { ref: 'modal', parent: this }),
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-3 item-control align-right' },
                        _react2.default.createElement(
                            'span',
                            { className: 'edit', onClick: this.openEdit.bind(this) },
                            'edit'
                        ),
                        ' | ',
                        _react2.default.createElement(
                            'span',
                            { className: 'delete',
                                onClick: this.handleDelete.bind(this), value: elem.id },
                            'delete'
                        )
                    )
                )
...
},{"./question-modal":178,"react":169}],180:[function(require,module,exports){
'use strict';
...
var _questionList = require('./question-list');
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_questionList2.default, { url: '/dashboard/topics/' + id + '/data' })
            );
        }
    }]);
...
},{"./question-list":177,"react":169}]},{},[170]);
